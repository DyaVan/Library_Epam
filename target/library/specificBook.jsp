...
<div class="container-fluid book-description-section">
    ...
    <div class="row reserve-section">
        ...
        <c:if test="${currentUser != null && accessLevel >= 6}">
            <div class="col-sm-2">
                <button type="button" id="btn-modify-book" class="btn btn-warning" name="rRoomReserve"
                        data-url="Library?command=modifyBook">Modify book
                </button>
            </div>
        </c:if>
...
<div class="modal fade" id="book-edit-modal" role="dialog">
        ...
        <div class="modal-content">
                ...
                <div class="modal-header">
                    <div class="jumbotron col-xs-12">
                        <h1>Modify Book</h1>
                        <p>Book ID: <c:out value="${specificBook.id}" escapeXml="true"/></p>
                    </div>
                </div>

                <div class="modal-body">
                    <div id="book-editor-section" >
                        <c:import url="WEB-INF/pages/parts/bookEditForm.jsp"/>
                    </div>
                </div>
