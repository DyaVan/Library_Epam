...
<div class="container">
    ...
    <div class="row">
        ...
        <ul class="nav nav-stacked nav-tab-custom col-md-2 col-xs-3">
            ...
            <li><a id="books-tabList-item" data-toggle="tab" href="#books">Books</a></li>
            ...
            <div id="books" class="tab-pane fade">
                ...
                <div class="container-fluid">
                    ...
                    <div id="book-editor-section" class="row">
                        <c:import url="parts/bookEditForm.jsp"/>
                    </div>
                    ...
                    <div id="roles" class="tab-pane fade">
                        ...
                        <div class="row block-tem">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control role-editing-item" disabled name="" value="5"
                                       min="1"
                                       max="5">
                            </div>
                            <div class="col-md-3">
                                <button id="btn-modify-role" type="button" class="btn btn-default" name="button">
                                    Modify
                                </button>
                                <div id="btn-group-role" class="btn-group" role="group" aria-label="...">
                                    <button id="btn-save-role" type="button" class="btn btn-default col-md-2">Save
                                    </button>
                                    <button id="btn-cancel-role" type="button" class="btn btn-danger col-md-2">Cancel
                                    </button>
                                </div>
                            </div>
                        </div>
