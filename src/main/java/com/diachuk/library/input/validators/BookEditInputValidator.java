 ...
 */
public class BookEditInputValidator extends InputValidator {
    ...
    public boolean validateInput(HttpServletRequest request) {
        ...
        while (iterator.hasNext()) {
            ...
            if (fileItem.isFormField()) {
                ...
                if (fileItem.getSize() != 0 && !fileItem.getContentType().equals("image/jpeg")) {
        ...
        inputValidationService.validateBookEditParameters(parameters);
        return inputValidationService.isInputValid();
    }
